			...
			<div className='container mx-auto px-6 py-20'>
				...
				<div className='text-center mb-16'>
					...
					<p className='text-xl text-gray-300 mb-12 max-w-3xl mx-auto'>
						Access essential healthcare services in one place. Your health, our
						priority.
					</p>
				</div>
				...
				<div className='grid md:grid-cols-2 gap-8 mb-16 max-w-4xl mx-auto'>
					...
					<div className='bg-gray-800 p-8 rounded-lg text-center hover:bg-gray-700 transition-colors'>
						...
						<p className='text-gray-300 mb-6'>
							Quick emergency ambulance service request and receive help
							instantly
						</p>
						<button
					...
					<div className='bg-gray-800 p-8 rounded-lg text-center hover:bg-gray-700 transition-colors'>
						...
						<p className='text-gray-300 mb-6'>
							Be a hero and save lives through blood donation
						</p>
						<button
